  ...
  return (
    <div className="justify-center flex">
        <div className="container lg:p-0 px-5">
            <motion.h1 initial={{opacity: 0, x: -200}} animate={{opacity: 1, x: 0}} transition={{type:"spring", stiffness: 100, damping: 10, duration: 1}}><span className="font-semibold flex w-full flex-wrap">Student ID: WEB8-1601 <br/> Assignment_ID:</span> Assignment_category_0001</motion.h1>
